...
function ProductCard({ productData, onClick }) {
    ...
    return (
        <div className="relative font-gill w-72 h-[35rem] inline-block my-4" onClick={onClick}>
            ...
            <button onClick={onClickAddToCart} className="absolute py-2 px-4 mt-2 bottom-2 text-zinc-50 font-bold bg-sky-400 rounded-full hover:bg-sky-600 hover:scale-105 duration-300">Add to Cart</button>
        </div>
    );
}
